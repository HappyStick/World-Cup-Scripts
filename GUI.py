...
# Creates an optionmenu in var countrymenu and tells it it's in root, that selectedCountry is its' first value, and to use all of countryList to populate it
